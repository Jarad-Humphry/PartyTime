...
public class TestSCHashtable{
	...
	public void testContainsAndDefinitionsAndisEmpty()
		...
		//System.out.println(table2.getDefinitions("oops"));
                //System.out.println(table2.getDefinitions("oops").toString());
		//ArrayList<Entry> list = new ArrayList<Entry>(10);
		//list = table.getWords();
		//list.add(
		//ArrayList<Entry> list2 = new ArrayList<Entry>(10);
		//list2 = table.getWords();
		//assertEquals(list, table2.getDefinitions("yes"));
		//assertEquals(list2, table2.getDefinitions("oops"));
...
//java.lang.String<[(noun) cool]> 
//java.util.ArrayList<[(noun) cool]>
